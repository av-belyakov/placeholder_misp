...
- GO_PHMISP_NSUBGETSENSORINFO - канал для запросов дополнительной информации
...
Для включения профилирования приложения необходимо настроить раздел DebugServer конфигурационных файлов, где задать параметры _DebugServer.enable_, _DebugServer.host_ и _DebugServer.port_.
Для того что бы получить доступ к профилировщику нужно выполнить в браузере или GET запросы с помощью wget или curl следующее:
