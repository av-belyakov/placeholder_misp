...
Профилирование приложения возможно только в режиме "development". Для того что бы получить доступ к профилировщику нужно выполнить в браузере или GET запросы с помощью wget или curl следующее:
